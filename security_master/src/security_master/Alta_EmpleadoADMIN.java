...
public class Alta_EmpleadoADMIN extends JFrame {
	int arte = 0;
	...
	public Alta_EmpleadoADMIN() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					if ( comboBoxArmas.getSelectedItem()==("Si") && comboBoxLibreta.getSelectedItem()==("Si")&&comboBoxFull.getSelectedItem()==("Si")) {
						 String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'VIP','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Alto A','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";
			 PreparedStatement pst=pruebaCn.prepareStatement(query);
                ...
                pst.setString(6, textFieldEmail.getText());
                  ...
                  pst.close();
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Alto B','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";
						 PreparedStatement pst=pruebaCn.prepareStatement(query);
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Alto C','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";						 PreparedStatement pst=pruebaCn.prepareStatement(query);
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Medio A','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";
						 PreparedStatement pst=pruebaCn.prepareStatement(query);
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Medio B','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";
						 PreparedStatement pst=pruebaCn.prepareStatement(query);
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Medio C','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";;
						 PreparedStatement pst=pruebaCn.prepareStatement(query);
						...
						String query="insert into Empleados (Ci,Nombre,Apellido,FechaNac,Direccion,Email,Estado,EstadoBaja,CategoriaEmpleado,sexo,desempeño) values(?,?,?,?,?,?,0,1,'Bajo','"+comboBox_1.getSelectedItem()+"','"+comboBox_2.getSelectedItem()+"')";
						 PreparedStatement pst=pruebaCn.prepareStatement(query);
		...
		label.setBounds(-110, -62, 1124, 724);
		panel.add(label);
